...
use App\Repositories\Eloquent\SalesmanPermissionRepositoryInterface;
use App\Repositories\Eloquent\BaseRepository;


class SalesmanPermissionRepository extends BaseRepository implements SalesmanPermissionRepositoryInterface
{


    public function boot()
    {
        $this->fieldSearchable = config('model.salesman_roles.salesman_permission.model.search');
    ...
    {
        return config('model.salesman_roles.salesman_permission.model.model');
    }
