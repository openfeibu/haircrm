...
use App\Traits\SalesmanRoles\PermissionHasRelations;

class SalesmanPermission extends BaseModel
{
     ...
     * @var array
     */
     protected $config = 'model.salesman_roles.salesman_permission.model';
