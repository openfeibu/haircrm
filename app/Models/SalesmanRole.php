...
use App\Traits\SalesmanRoles\RoleHasRelations;
use App\Traits\Trans\Translatable;
use App\Contracts\RoleHasRelations as RoleHasRelationsContract;

class SalesmanRole extends BaseModel implements RoleHasRelationsContract
{
     ...
     * @var array
     */
    protected $config = 'model.salesman_roles.salesman_role.model';
