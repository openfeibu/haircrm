    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('mail_schedule/'.$mail_schedule->id)}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            @foreach( $mailAccountRepository->getAll() as $key => $mail_account)
                                <input type="checkbox" name="mail_accounts[]"  title="{{ $mail_account->username }}" value="{{ $mail_account->id }}" @if(in_array($mail_account->id ,$mail_account_ids)) checked @endif>
                            @endforeach
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            @foreach( $mailTemplateRepository->getAll() as $key => $mail_template)
                                <input type="checkbox" name="mail_templates[]" title="{{ $mail_template->name }}" value="{{ $mail_template->id }}" @if(in_array($mail_template->id ,$mail_template_ids)) checked @endif>
                            @endforeach
