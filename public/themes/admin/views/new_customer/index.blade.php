...
<script type="text/html" id="barDemo">
    @{{# if(d.mark == 'new'){ }}
    <a class="layui-btn layui-btn-sm" href="{{ guard_url('customer/create') }}?new_customer_id=@{{ d.id }}">转入客户</a>
    @{{# } }}
    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'salesman_name',title:'{{ trans('salesman.label.name') }}', width:120,sort:true,fixed:'left'}
