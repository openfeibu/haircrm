    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'port',title:'{{ trans('salesman.label.port') }}'}
                ,{field:'from_address',title:'{{ trans('mail_account.label.from_address') }}',edit:'text'}
                ,{field:'username',title:'{{ trans('mail_account.label.username') }}',edit:'text'}
