                ...
                <form class="layui-form" action="{{guard_url('mail_account')}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="host" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('mail_account.label.host') }}" class="layui-input" value="{{ $mail_account->host }}">
                        </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="port" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('mail_account.label.port') }}" class="layui-input" value="{{ $mail_account->port }}">
                        </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="address" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('mail_account.label.address') }}" class="layui-input" value="{{ $mail_account->address }}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('mail_account.label.name') }}" class="layui-input" value="{{ $mail_account->name }}">
                        </div>
                    </div>
