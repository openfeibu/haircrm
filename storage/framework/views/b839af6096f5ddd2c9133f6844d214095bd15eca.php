    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'mobile',title:'<?php echo e(trans('new_customer.label.mobile')); ?>',edit:'text'}
                ,{field:'imessage',title:'<?php echo e(trans('new_customer.label.imessage')); ?>',edit:'text'}
                ,{field:'whatsapp',title:'<?php echo e(trans('new_customer.label.whatsapp')); ?>',edit:'text'}
                ,{field:'main_product',title:'<?php echo e(trans('new_customer.label.main_product')); ?>',edit:'text'}
                ,{field:'ig',title:'<?php echo e(trans('new_customer.label.ig')); ?>',edit:'text'}
                ,{field:'ig_follower_count',title:'<?php echo e(trans('new_customer.label.ig_follower_count')); ?>',edit:'text'}
                ,{field:'ig_sec',title:'<?php echo e(trans('new_customer.label.ig_sec')); ?>',edit:'text'}
                ,{field:'facebook',title:'<?php echo e(trans('new_customer.label.facebook')); ?>',edit:'text'}
                ,{field:'mark_desc',title:'<?php echo e(trans('new_customer.label.mark')); ?>', width:120, fixed: 'right'}
