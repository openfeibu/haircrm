            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('new_customer')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="company_name" lay-verify="required" autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.company_name')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                        <input type="text" name="email"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.email')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="mobile"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.mobile')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="imessage"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.imessage')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="whatsapp"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.whatsapp')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ig"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.ig')); ?>" class="layui-input">
                        </div>
                    </div>
