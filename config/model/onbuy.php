...
// Modale variables for page module.
    'product'     => [
        ...
        'visible'      => [],
        'guarded'      => ['*'],
        'fillable'     => ['name', 'sku','group_sku',  'price','stock','product_listing_id','product_listing_condition_id','condition','handling_time','boost_marketing_commission','original_price','min_price','purchase_price','weight','product_encoded_id','delivery_weight','delivery_template_id','opc','product_url','image_url','sale_price','total_in_inventory','purchase_url','created_at','updated_at'],
        'translate'    => [],
        'upload_folder' => '',
        'encrypt'      => ['id'],
        'revision'     => ['name'],
    ...
    'order_product'     => [
        ...
        'visible'      => [],
        'guarded'      => ['*'],
        'fillable'     => ['order_id', 'onbuy_internal_reference','name','sku','seller_delivery_template_id','price_delivery_total','condition','condition_id','quantity','quantity_dispatched','unit_price','total_price','expected_dispatch_date','expected_delivery_date','file_location_prefix','opc','image_urls','tax_delivery','tax_product','tax_total','commission_fee','commission_fee_including_tax'],
        'translate'    => [],
        'upload_folder' => '',
        'encrypt'      => ['id'],
        'revision'     => ['name'],
